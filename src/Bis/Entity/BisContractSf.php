 ...
 * @package Bis\Entity
 *
 * @ORM\Entity(repositoryClass="Bis\Repository\BisContractSfRepository")
...
class BisContractSf
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bis\Entity\BisPersonSf", inversedBy="contracts")
     * @ORM\JoinColumn(name="con_per_id", referencedColumnName="per_id", nullable=true)
     */
    private $conPerId;

    /**
     * @ORM\OneToMany(targetEntity="Bis\Entity\BisConjobSf", mappedBy="fkConId")
