...
use Bis\Entity\BisConjobSf;
use Bis\Entity\BisContractSf;
use Bis\Entity\BisJobSf;
...
class BisPersonView
{
    ...
    {
        $this->bis = $bis;
        $this->repository = $this->bis->getRepository(\Bis\Entity\BisPersonView::class);
    }

    /**
     * @param String $email
     *
     * @return \Bis\Entity\BisPersonView|null
     */
     ...
     * @param array $user
     *
     * @return \Bis\Entity\BisPersonView
     * @throws \Doctrine\ORM\ORMException
     * @throws \Doctrine\ORM\OptimisticLockException
     * @throws \Doctrine\ORM\TransactionRequiredException
     */
    public function createPerson(array $user): \Bis\Entity\BisPersonView
    {
        ...
        $bisPersonView = $this->bis->find(\Bis\Entity\BisPersonView::class, $user['id']);

        // If the record is inactive, we make a fake record
        if (empty($bisPersonView)) {
            $bisPersonView = new \Bis\Entity\BisPersonView();
            $bisPersonView
                ->setId($user['id'])
