...
class AdldapAuthenticator implements AuthenticatorInterface
{
     ...
     */
    public function __construct(FormFactoryInterface $formFactory, EntityManager $em, RouterInterface $router, ActiveDirectory $activeDirectory, BisDir $bisDir, LoggerInterface $logger, Account $account)
    {
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (null === $username) {
            throw new UserNotFoundException('Username can\'t be empty!');
        }
